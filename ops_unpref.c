...
void run_inst(uint16_t opcode, CPU *cpu){
    ...
    case 0xB6:  //OR [HL]
        ...
        case 0xCE:  //ADC A, u8
            u8 = read8(cpu, ++cpu->pc) + (reg->f & FLAG_C);
            set_N(0, cpu);
            set_H_add(reg->a, u8, cpu);
            set_C_add(reg->a, u8, cpu);
            reg->a += u8;
        ...
        case 0xEA:  //LD u16, A
            u16 = read16(cpu, ++cpu->pc);   // Read next two bytes as 16-bit address
